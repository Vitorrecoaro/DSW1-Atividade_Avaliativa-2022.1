...
CREATE TABLE IF NOT EXISTS LOJA(
    ...
    CONSTRAINT pk_loja PRIMARY KEY (loja_id, loja_CNPJ)
);
...
CREATE TABLE IF NOT EXISTS USUARIO(
    ...
    CONSTRAINT pk_user PRIMARY KEY (`user_id`, user_CPF)
);
...
CREATE TABLE IF NOT EXISTS VEICULO(
    ...
    CONSTRAINT pk_veic PRIMARY KEY (veic_id, veic_placa)
);
